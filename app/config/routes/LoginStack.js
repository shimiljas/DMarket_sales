...
const LoginStack = createStackNavigator(
  {
    ...
    SignupScreen: { screen: SignupScreen, navigationOptions: option },
    OTPScreen: { screen: OTPScreen, navigationOptions: option },
    ForgotPassword: { screen: ForgotPassword, navigationOptions: option }
  },
  {
